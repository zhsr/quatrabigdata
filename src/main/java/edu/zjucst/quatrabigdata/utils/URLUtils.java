...
public class URLUtils {
	...
	public static String getContent(String url) {
		...
		try {
			...
			urlConn.addRequestProperty("Accept-Language", "zh-CN,zh;q=0.8,en-US;q=0.5,en;q=0.3");
			...
			bufin = new BufferedReader(new InputStreamReader(in, "GBK"));// GBK编码格式
	...
	public static String getContentByCharSet(String url,String charset) {
		HttpURLConnection urlConn = null;
		InputStream in = null;
		BufferedReader bufin = null;
		...
		try {
			...
			in = urlConn.getInputStream();
			bufin = new BufferedReader(new InputStreamReader(in, charset));
			while ((str = bufin.readLine()) != null) {
				sb.append(str + "\r\n");
			}
		} catch (IOException e) {
	...
	public static String getContent(String url, String cookie,
		...
		try {
			...
			urlConn.addRequestProperty("Accept-Language", "zh-CN,zh;q=0.8");
			urlConn.addRequestProperty("User-Agent","Mozilla/5.0 (X11; Linux x86_64; rv:17.0) Gecko/20131029 Firefox/17.0");
			urlConn.addRequestProperty("DNT", "1");
			urlConn.addRequestProperty("Connection", "keep-alive");
			urlConn.addRequestProperty("Cache-Control", "max-age=0");
			urlConn.addRequestProperty("Cookie", cookie);
